    ...
    <body class=" login_page">
        ...
        <div class="register-wrapper">
            <div id="register" class="login loginpage col-lg-offset-4 col-lg-4 col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 col-xs-offset-2 col-xs-8">
                ...
                <form name="loginform" id="loginform" role="form" method="POST" action="{{ url('/register') }}">
                        {!! csrf_field() !!}

                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="user_login">Name</label>

                                <input type="text"  placeholder="Nama" class="input" id="user_login" name="name" value="{{ old('name') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="user_login">E-Mail Address</label>
                                <input type="email"  placeholder="Email Address" class="input" name="email" id="user_login" value="{{ old('email') }}">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <label for="user_pass">Password</label>
                                <input type="password" placeholder="Password" id="user_pass" class="input" name="password">
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            <label for="user_pass_2" >Confirm Password</label>
                                ...
                                <input type="password" placeholder="Confirm Password" id="user_pass_2" class="input" name="password_confirmation">
                ...
                <p id="nav">
                    <a class="pull-left" href="{{ url('/password/reset') }}" title="Password Lost and Found">
                    Forgot password?</a>
