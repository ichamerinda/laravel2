                ...
                <form name="loginform" id="loginform" method="POST" action="{{ url('/login') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <label for="user_login">E-Mail Address</label>
                                ...
                                <input type="email" id="user_login" class="input"  name="email" value="{{ old('email') }}">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <label for="user_pass">Password</label>
                                ...
                                <input type="password" id="user_pass" class="input" name="password">
						...
						<p class="forgetmenot">
							<label class="icheck-label form-label" for="rememberme"><input name="remember" type="checkbox" value="forever" class="skin-square-orange" checked> Remember me</label>
						</p>

                        <div class="form-group">
                            <button type="submit" href="login" class="btn btn-orange btn-block">Sign In</button>
                        </div>
                    </form>

                <p id="nav">
                    <a class="pull-left" href="{{ url('/password/reset') }}" title="Password Lost and Found">Forgot password?</a>
                    <a class="pull-right" href="register" title="Sign Up">Sign Up</a>
                </p>
