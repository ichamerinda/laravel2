                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Selamat Datang..</h1>                            </div>
                            ...
                            <div class="pull-right hidden-xs">
                                <ol class="breadcrumb">
                                    ...
                                    <li>
                                        <a href="ui-typography.html">More Inforamtion</a>
                                    </li> 
                                </ol>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Lembaga Pengelola Zakat Ummul Quro Jombang</h2>
                                        ...
                                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                                            ...
                                            <div class="carousel-inner" role="listbox">
                                                <div class="item active">
                                                    <img src="assets/images/image1.jpg" style="width:80%;">
                                                </div>
                                                <div class="item">
                                                    <img src="assets/images/image2.jpg" style="width:80%;">
                                                </div>
                                                <div class="item">
                                                    <img src="assets/images/image3.jpg" style="width:80%;">
                                                </div>    
                                            </div>
